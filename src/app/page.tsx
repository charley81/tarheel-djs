  ...
  return (
    <main className="flex flex-col items-center pt-36 p-4">
      <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
        Find{' '}
        <span className="text-sky-300 font-bold italic underline">
          DJ&apos;s
        </span>{' '}
        in NC
      </h1>
      ...
      <form className="w-full sm:w-[580px]">
        <input
          className="w-full h-16 rounded-md bg-slate-50/[8%] px-6 outline-none ring-sky-300 transition focus:ring-2"
          type="text"
